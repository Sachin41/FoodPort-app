...
const Bill = ({total}) => {
  ...
  return (
    <>
                  <p className='text-md font-semibold text-black mb-4'>Bill Detail</p>
              <div className="flex justify-between w-full mb-2 text-sm text-gray-600 font-semibold">
                <p>Item Total</p>
                <p>₹{total}</p>
              </div>
              <div className="flex justify-between w-full mb-2 text-sm text-gray-600 font-semibold">
              ...
              <div className="flex justify-between w-full pt-2 mb-2 border-t border-gray-200
